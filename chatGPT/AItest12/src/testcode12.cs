...
// Kysytty 26.3.2024 korjausversio AItest11, korjauskehotus "tulostus on tyhjä"
...
class Program
{
    static void Main()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            do
            {
                lisänumero = random.Next(1, 41); // Arvotaan lisänumero
            } while (OnkoNumeroJoLottorivissa(lottoTaulukko, i, lisänumero)); // Tarkista, ettei numero ole jo lottorivissä
