...
// Kysytty 9.4.2024 'tarkempi' kysely korjaus AItest03 'funktiot ei saa palauttaa mitään'
...
class Program
{
    ...
    static void LaskeHypynPisteet()
    {
        ...
        double keskimmäistenTuomarienPisteet = tuomareidenPisteet.Skip(1).Take(3).Sum();
        pisteet = (hypynPituus - kriittinenPiste) * 1.8 + keskimmäistenTuomarienPisteet + 60;
    }
