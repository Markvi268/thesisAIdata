...
class Program
{
    static void Main(string[] args)
    {
        ...
        LaskeHypynPisteet(hypynPituus, tuomariPisteet, out double pisteet);
    ...
    static void LaskeHypynPisteet(double hypynPituus, double[] tuomariPisteet, out double pisteet)
    {
        ...
        pisteet = (hypynPituus - kriittinenPiste) * 1.8 + keskiarvo + 60;
    }
