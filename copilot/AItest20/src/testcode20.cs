...
// Kysytty 31.3.2024 uusi 'tasapainoinen' kysely. Itse kommentoitu 'Console.Write("Lottorivi: ");'
...
namespace Lotto
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Arvo seitsemän varsinaista numeroa (1-40)
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                } while (Array.Exists(lottoNumerot, num => num == arvottuNumero)); // Tarkistetaan, ettei numero ole jo lottorivissä
