...
// Kysytty 27.3.2024 uusi 'luovempi' kysely
...
class Lotto
{
    static void Main()
    {
        ...
        // Lajitellaan ensimmäiset seitsemän numeroa
        Array.Sort(lottoNumbers, 0, 7);

        // Arvotaan lisänumero, joka ei ole jo arvottujen joukossa
        int extraNumber;
        do
        {
            extraNumber = rng.Next(1, 41);
