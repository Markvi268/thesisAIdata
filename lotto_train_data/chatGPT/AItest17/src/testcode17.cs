...
// Kysytty 27.3.2024 korjaus AItest16 versiosta pyydetty 'error CS1501: No overload for method 'Exists' takes 4 arguments'
...
class Program
{
    static void Main()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            } while (Array.IndexOf(lottoRivi, arvottuNumero, 0, i) != -1); // Tarkistetaan, onko numero jo lottoRivissä
        ...
        } while (Array.IndexOf(lottoRivi, lisänumero, 0, 7) != -1); // Tarkistetaan, ettei lisänumero ole mukana varsinaisissa numeroissa
